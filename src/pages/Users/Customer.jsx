...
const Customer = () => {
  ...
  useEffect(() => {
    dispatch(getRoleUsers('CUSTOMER'));
  }, [dispatch]);
  ...
  const handleToggleActive = async (userId) => {
    const result = await dispatch(activeDeactiveUser({ userId, loginId: userLoginData?.user?.userId }))
    ...
    <MainLayout>
      <Container className="mt-4">
        ...
        <UserForm
          ...
          initialData={null} // Pre-set role to MANAGER
        />
