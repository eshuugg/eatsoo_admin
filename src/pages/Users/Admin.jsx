...
const Admin = () => {
  ...
  const { roleUserData, usersByRole, loading, error, pagination } = useSelector(state => state.userData);
    ...
    return (
      <MainLayout>
        <Container className="mt-4 text-center">
          ...
          <p className="mt-2">Loading {roleName} users...</p>
        </Container>
      </MainLayout>
    );
  }
    ...
    <MainLayout>
      <Container className="mt-4">
        ...
        <UserForm
          ...
          initialData={null} // Pre-set role to ADMIN for admin users
        />
